  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Text style={{color: focused ? "blue" : "gray",fontSize:10}}>Home</Text></View>
...
<Tab.Screen   name="Portfolio" component={Portfolio} options={{
        ...
        height:17,
        tintColor:focused ? "blue" : "gray",}}/>
        <Text style={{color: focused ? "blue" : "gray",fontSize:10}}>Portfolio</Text></View>
...
<Tab.Screen   name="Prices" component={Prices} options={{
        ...
        height:17,
        tintColor:focused ? "blue" : "gray",}}/>
        <Text style={{color: focused ? "blue" : "gray",fontSize:10}}>Prices</Text></View>
        ...
        height:17,
        tintColor:focused ? "blue" : "gray",}}/>
        <Text style={{color: focused ? "blue" : "gray",fontSize:10}}>Settings</Text></View>
